...
class Trader:
    ...
    def train(self, training_data, testing_data):
        ...
        Q, total_losses, total_rewards = train_dqn(Environment1(training_data))
        plot_loss_reward(total_losses, total_rewards)
        plot_train_test_by_q(Environment1(training_data), Environment1(testing_data), len(training_data), Q, 'DQN')
